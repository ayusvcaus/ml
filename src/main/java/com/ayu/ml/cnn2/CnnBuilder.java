...
public class CnnBuilder {
    ...
    public CnnBuilder setInputLayer(Size size) {
        inputLayerBuilder = new InputLayerBuilder(size);
        return this;
    }
    ...
    public CnnBuilder addSampleLayer(Size size) {
        layerBuilders.add(new SampleLayerBuilder(size));
        return this;
    }
    ...
    private static class SampleLayerBuilder implements LayerBuilder {
        private final Size scaleSize;

        public SampleLayerBuilder(Size scaleSize) {
